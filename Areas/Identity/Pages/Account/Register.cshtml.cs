...
namespace Both_TamasArpad_Lab2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Both_TamasArpad_Lab2.Data.Both_TamasArpad_Lab2Context context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var callbackUrl = Url.Page("/Account/ConfirmEmail", pageHandler: null,
                    values: new { area = "Identity", userId = userId, code = code, returnUrl = returnUrl }, protocol: Request.Scheme);
