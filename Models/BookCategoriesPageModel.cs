...
namespace Both_TamasArpad_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Both_TamasArpad_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Both_TamasArpad_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
